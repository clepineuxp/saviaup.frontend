...
- En móvil, arrastrar hacia abajo desde el inicio de la página de ventas muestra una verificación explícita: comprueba SignalR y vuelve a consultar el snapshot de mesas. El plano incluye controles de zoom entre 50 % y 175 % que escalan únicamente las mesas y sus coordenadas, sin afectar métricas, barras ni diálogos.
